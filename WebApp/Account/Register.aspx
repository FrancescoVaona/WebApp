...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="Cognome" CssClass="col-md-2 control-label">Cognome</asp:Label>
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="Cognome" CssClass="form-control" />
                <asp:RequiredFieldValidator runat="server" ControlToValidate="Cognome"
